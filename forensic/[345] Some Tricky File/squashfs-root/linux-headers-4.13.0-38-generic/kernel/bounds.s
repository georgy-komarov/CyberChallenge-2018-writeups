...
# -MD kernel/.bounds.s.d /build/linux-cg_do7/linux-4.13.0/kernel/bounds.c
...
1:	call	__fentry__
	pushq	%rbp	#
	movq	%rsp, %rbp	#,
# /build/linux-cg_do7/linux-4.13.0/kernel/bounds.c:18: 	DEFINE(NR_PAGEFLAGS, __NR_PAGEFLAGS);
#APP
# 18 "/build/linux-cg_do7/linux-4.13.0/kernel/bounds.c" 1
	
.ascii "->NR_PAGEFLAGS $25 __NR_PAGEFLAGS"	#
# 0 "" 2
# /build/linux-cg_do7/linux-4.13.0/kernel/bounds.c:19: 	DEFINE(MAX_NR_ZONES, __MAX_NR_ZONES);
# 19 "/build/linux-cg_do7/linux-4.13.0/kernel/bounds.c" 1
	
.ascii "->MAX_NR_ZONES $5 __MAX_NR_ZONES"	#
# 0 "" 2
# /build/linux-cg_do7/linux-4.13.0/kernel/bounds.c:21: 	DEFINE(NR_CPUS_BITS, ilog2(CONFIG_NR_CPUS));
# 21 "/build/linux-cg_do7/linux-4.13.0/kernel/bounds.c" 1
	
.ascii "->NR_CPUS_BITS $13 ilog2(CONFIG_NR_CPUS)"	#
# 0 "" 2
# /build/linux-cg_do7/linux-4.13.0/kernel/bounds.c:23: 	DEFINE(SPINLOCK_SIZE, sizeof(spinlock_t));
# 23 "/build/linux-cg_do7/linux-4.13.0/kernel/bounds.c" 1
	
.ascii "->SPINLOCK_SIZE $4 sizeof(spinlock_t)"	#
# 0 "" 2
# /build/linux-cg_do7/linux-4.13.0/kernel/bounds.c:25: }
#NO_APP
	popq	%rbp	#
	ret
	.size	foo, .-foo
